...
var insert = require('./beerAndFries').insert;
var beerAndFries = require('./beerAndFries.js').beerAndFries;

exports.testInsertReturns = function (test) {
    test.deepEqual([1, 2, 3, 4, 4, 5], insert(3, [1, 2, 4, 4, 5]));
    test.done();
};

exports.testInsertChanges = function (test) {
    var arr = [1, 2, 4, 4, 5];
    insert(3, arr);

    test.deepEqual([1, 2, 3, 4, 4, 5], arr);
    test.done();
};
